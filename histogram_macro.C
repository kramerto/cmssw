...
std::string name_("FEF28D68-A4AF-E511-A3FD-0025904C63F8");
...
void histogram_macro() {
  ...
  //  dEdx_vs_p(false, 5000, 15, 1400, 1000, 0, 15, "recoHarmonic2");
  ...
  dEdx_vs_eta(false, 115, -2.3, 2.3, 1000, 0, 10, "recoHarmonic2", 15);
  dEdx_vs_eta(false, 115, -2.3, 2.3, 1000, 0, 10, "myHarmonic2", 15);
  //  dEdx_vs_eta(false, 230, -2.3, 2.3, 1000, 0, 10, "myHarmonic2Pixel");
  //  dEdx_vs_eta(false, 230, -2.3, 2.3, 1000, 0, 10, "myHarmonic2Strip");
  //  dEdx_vs_phi(false, 100, 0, 3.1416, 1000, 0, 10, "recoHarmonic2");
  //  dEdx_vs_phi(false, 100, 0, 3.1416, 1000, 0, 10, "myHarmonic2");
  //  dEdx_vs_phi(false, 100, 0, 3.1416, 1000, 0, 10, "myHarmonic2Pixel");
  //  dEdx_vs_phi(false, 100, 0, 3.1416, 1000, 0, 10, "myHarmonic2Strip");
  //  dEdx_vs_runID(false, 4000, 257000, 261000, 1000, 0, 10, "recoHarmonic2");
  //  dEdx_vs_runID(false, 4000, 257000, 261000, 1000, 0, 10, "myHarmonic2");
  //  dEdx_vs_runID(false, 4000, 257000, 261000, 1000, 0, 10,
  //  "myHarmonic2Pixel");
  //  dEdx_vs_runID(false, 4000, 257000, 261000, 1000, 0, 10,
  //  "myHarmonic2Strip");
}
...
void massHistogram(bool save, int bins, double minMass, double maxMass,
  ...
  for (unsigned int i = 0; i < dEdxAllParticles.size(); i++) {
    if (dEdxAllParticles[i] > dEdxCut) {
      massHisto->Fill(
          pAllParticles[i] *
          TMath::Sqrt((dEdxAllParticles[i] - protonFunction->GetParameter(0)) /
  ...
  for (unsigned int i = 0; i < dEdx2212.size(); i++) {
    if (dEdx2212[i] > dEdxCut) {
      massHisto2212->Fill(
          p2212[i] *
          TMath::Sqrt((dEdx2212[i] - protonFunction->GetParameter(0)) /
                      protonFunction->GetParameter(1)));
    }
  }
  for (unsigned int i = 0; i < dEdx321.size(); i++) {
    if (dEdx321[i] > dEdxCut) {
      massHisto321->Fill(
          p321[i] * TMath::Sqrt((dEdx321[i] - protonFunction->GetParameter(0)) /
                                protonFunction->GetParameter(1)));
    }
  }
  ...
  for (unsigned int i = 0; i < dEdxBSM.size(); i++) {
    if (dEdxBSM[i] > dEdxCut) {
      massHistoBSM->Fill(
          pBSM[i] * TMath::Sqrt((dEdxBSM[i] - protonFunction->GetParameter(0)) /
                                protonFunction->GetParameter(1)));
    }
  }
