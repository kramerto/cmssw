...
void histogram_macro() {
  ...
  dEdx_vs_p = new TH2D("dEdx_vs_p", "dEdx_vs_p", 100, 0, 5, 100, 0, 10);
  ...
  dEdx_vs_p_11 =
      new TH2D("dEdx_vs_p_11", "dEdx_vs_p_11", 100, 0, 5, 100, 0, 10);

  dEdx_vs_p_2212 =
      new TH2D("dEdx_vs_p_2212", "dEdx_vs_p_2212", 100, 0, 5, 100, 0, 10);
  ...
  dEdx_vs_pCanvas->SetFillColor(0);
  ...
  //  // draw the histogram
  //  tree->Draw("dEdx:p>>dEdx_vs_p", "dEdx>0");
  //  dEdx_vs_p->Draw("colz");
  ...
  // legend
  dEdx_vs_pLegend = new TLegend(0.5, 0.7, 0.84, 0.9);
  dEdx_vs_pLegend->SetTextSize(0.05);
  dEdx_vs_pLegend->AddEntry(dEdx_vs_p_211, "#pi^{+/-}", "p");
  dEdx_vs_pLegend->AddEntry(dEdx_vs_p_321, "K^{+/-}", "p");
  dEdx_vs_pLegend->AddEntry(dEdx_vs_p_2212, "p^{+/-}", "p");
  dEdx_vs_pLegend->AddEntry(dEdx_vs_p_11, "e^{+/-}", "p");
